...
This file is the quick-reference operating contract for tungstenite-kotlin. The longer
...
tungstenite-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`tungstenite`](https://crates.io/crates/tungstenite). Upstream Rust is the behavioral oracle while the
