...
kotlin {
    ...
    swiftExport {
        moduleName = "Tungstenite"
        flattenPackage = "io.github.kotlinmania.tungstenite"
    }

    android {
        namespace = "io.github.kotlinmania.tungstenite"
...
mavenPublishing {
    ...
    coordinates(group.toString(), "tungstenite-kotlin", version.toString())

    pom {
        name.set("tungstenite-kotlin")
        description.set("Kotlin Multiplatform port of snapview/tungstenite-rs - Lightweight stream-based WebSocket implementation")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/tungstenite-kotlin")
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleTungsteniteXCFramework",
    "assembleTungsteniteDebugXCFramework",
    "assembleTungsteniteReleaseXCFramework",
    "assembleDebugIosFatFrameworkForTungsteniteXCFramework",
    "assembleReleaseIosFatFrameworkForTungsteniteXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForTungsteniteXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForTungsteniteXCFramework",
    "assembleDebugMacosFatFrameworkForTungsteniteXCFramework",
    "assembleReleaseMacosFatFrameworkForTungsteniteXCFramework",
    "assembleDebugTvosFatFrameworkForTungsteniteXCFramework",
    "assembleReleaseTvosFatFrameworkForTungsteniteXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForTungsteniteXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForTungsteniteXCFramework",
    "assembleDebugWatchosFatFrameworkForTungsteniteXCFramework",
    "assembleReleaseWatchosFatFrameworkForTungsteniteXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForTungsteniteXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForTungsteniteXCFramework",
